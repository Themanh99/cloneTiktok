          ...
          <div className={cx('divwrapper')}>
            <div className={cx('logincontainer')}>
              <div className={cx('homecontainer')}>
                ...
                <div className={cx('divdescription')}>Email or username</div>
                <form onSubmit={handleSubmit}>
                  ...
                  <div className={cx('inputcontain')}>
                    ...
                    />
                    <div className={cx('iconcontain')}>
                      <i tabIndex={0} role="button" className={cx('pswdicon')}>
                        <svg
                  ...
                  <a href="/login/email/forget-password" className={cx('linkbtn')}>
                    Forgot password?
                  </a>
                  <button type="submit" data-e2e="login-button" className={cx('button-style')} id="btn-disa">
                    Log in
                  </button>
                </form>
                <div className={cx('boxcontainer')} tabIndex={0} role="button" data-e2e="channel-item">
